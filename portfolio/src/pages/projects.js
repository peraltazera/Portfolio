    ...
    <>
      ...
      <main className='flex w-full flex-col items-center justify-center'>
        <Layout className=' pt-16'>
          ...
          <AnimatedText text="Imaginação supera conhecimento!" className='mb-2' />

          <motion.div initial={{x:100}} whileInView={{x:0}} transition={{duration:0.8}} viewport={{once:true}} className=' flex flex-col-reverse w-full justify-center items-center 
            drop-shadow-dark bg-darkSec py-12 px-10 md:rounded-3xl lg:flex-row md:px-12 gap-8 lg:gap-0'>
              ...
              <div className=' w-full flex flex-col justify-between px-0 lg:w-1/2 lg:px-8 gap-6'>
                ...
                <p className=' font-medium text-light/60'>Web&nbsp;&nbsp;|&nbsp;&nbsp;Javascript&nbsp;&nbsp;|&nbsp;&nbsp;HTML&nbsp;&nbsp;|&nbsp;&nbsp;Tailwind&nbsp;&nbsp;
                |&nbsp;&nbsp;ReactJs&nbsp;&nbsp;|&nbsp;&nbsp;NextJs</p>
            ...
            <motion.div initial={{x:100}} whileInView={{x:0}} transition={{duration:0.8}} viewport={{once:true}} className=' flex flex-col w-full justify-center items-center 
            drop-shadow-dark bg-darkSec py-12 px-10 md:rounded-3xl lg:flex-row md:px-12 gap-8 lg:gap-0'>
              <div className=' w-full flex flex-col justify-between px-0 lg:w-1/2 lg:px-8 gap-6'>
                <h2 className=' font-bold text-2xl md:text-4xl w-full text-light mt-4'>Chess Bot<span className=' text-primary'>&nbsp;&nbsp;|&nbsp;&nbsp;</span>Discord</h2>
                <p className=' font-medium text-lg text-light'>O Open chat é uma plataforma aberta que permite que você se conecte com qualquer pessoa cadastrada no Google Gmail. 
                Com essa ferramenta, é possível enviar mensagens para amigos, colegas de trabalho e outras pessoas de sua rede.</p>
                <p className=' font-medium text-light/60'>Discord&nbsp;&nbsp;|&nbsp;&nbsp;Javascript&nbsp;&nbsp;|&nbsp;&nbsp;Discord.js&nbsp;&nbsp;|&nbsp;&nbsp;Bot&nbsp;&nbsp;
                |&nbsp;&nbsp;NodeJs&nbsp;&nbsp;|&nbsp;&nbsp;CanvasJs</p>
                <div className=' flex items-center self-start gap-6'>
            ...
            drop-shadow-dark bg-darkSec py-12 px-10 md:rounded-3xl lg:flex-row md:px-12 gap-8 lg:gap-0'>
              ...
              <div className=' w-full flex flex-col justify-between px-0 lg:w-1/2 lg:px-8 gap-6'>
                ...
                <p className=' font-medium text-lg text-light'>O Open chat é uma plataforma aberta que permite que você se conecte com qualquer pessoa cadastrada no Google Gmail. 
                Com essa ferramenta, é possível enviar mensagens para amigos, colegas de trabalho e outras pessoas de sua rede.</p>
                <p className=' font-medium text-light/60'>Unity&nbsp;&nbsp;|&nbsp;&nbsp;C#&nbsp;&nbsp;|&nbsp;&nbsp;2D&nbsp;&nbsp;|&nbsp;&nbsp;Chess&nbsp;&nbsp;
                |&nbsp;&nbsp;Webgl&nbsp;&nbsp;|&nbsp;&nbsp;Game</p>
                <div className=' flex items-center self-start gap-6'>
